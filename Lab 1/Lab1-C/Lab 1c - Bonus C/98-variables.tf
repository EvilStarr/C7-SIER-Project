...
variable "sns_email_endpoint" {
  ...
  type        = string
  default     = "jdollas@gmail.com" # TODO: student supplies
}
...
variable "route53_hosted_zone_id" {
  type    = string
  default = "Z0945475TIBJJA1MRRZ4"

  validation {
    condition     = var.route53_hosted_zone_id == "Z0945475TIBJJA1MRRZ4" || can(regex("^[A-Z0-9]{21}$", var.route53_hosted_zone_id))
    error_message = "route53_hosted_zone_id must be empty or a valid 21-character Route 53 hosted zone ID (e.g. Z012Z0945475TIBJJA1MRRZ43456789ABCDEF)."
  }
}
